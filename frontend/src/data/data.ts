...
export const sampleFoods: Food[] = [
    ...
    },
    {
      ...
      name: 'Falafel Wrap',
      price: 6.5,
      tage: ['Middle Eastern', 'Vegetarian'],
      favorite: false,
      stars: 4.3,
      imageUrl: '/assets/food/food3.jpeg',
